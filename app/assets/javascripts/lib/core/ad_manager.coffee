define ->
  ...
  adManager =
    init : (_config,_target) ->
      ...
      iframe.src = "#{_config.service}/#{_config.adZone};#{_config.adKeywords};#{_config.segQS};tile=#{_config.tile};mtfIFPath=#{_config.mtfIFPath};sz=#{_config.unit[0]}x#{_config.unit[1]};ord=#{ord}?"
