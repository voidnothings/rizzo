define ['jquery'], ($)->
  ...
  class Authenticator
    ...
    showUserBox: ->
      ...
      userBoxElement = "<div class='nav__item nav__item--user user-box js-user-box nav__submenu__trigger icon--chevron-down--grey--after'><img class='user-box__img js-box-handler' src='#{@userAvatar()}'/></div>"
